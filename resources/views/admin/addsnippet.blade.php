  ...
  <div class="flex flex-col">
    <div class="flex justify-center bg-gray-300 h-24 p-3 drop-shadow-2xl  top-0">
      <div class="flex flex-col space-x-3">
        ...
        <h4 class="font-bold text-black mt-7  text-xl">Add Snippet</h4>
    ...
    <div class="bg-gray-300 min-h-screen align-items-lg-start">
      ...
      <div class="px-20 py-10 rounded mx-auto">
        ...
        <form class="flex flex-col gap-y-8  h-full" method="POST" action="/addsnippet">
          @csrf
          <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="body">
              Enter Snippet
            </label>
            <input class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="body" id="body" type="text" placeholder= "Body">
          </div>
          <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="body_eng">
              Enter Translated Snippet
            </label>
            <input class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="body_eng" id="body_eng" type="text" placeholder="Body in English">
          </div>
          <div class="mb-4">
